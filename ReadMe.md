...
### Этап 1: классы KeyPair и Signature (update 24.06.2022)
 ...
 **big-integer** (*BigInteger.js*)
 ...
 В файле *stage1.js* реализовал классы KeyPair и Signature, которые получились оболочкой для функций из библиотеки RSA.
